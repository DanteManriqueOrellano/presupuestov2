...
export function handleGraphQLContext(req: any): Promise<IContext> {
...
export function handleSubscriptionsContext(connectionParams:any, _webSocket:any): Promise<IContext> {
